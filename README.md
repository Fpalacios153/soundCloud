...
* Request
  * Method: PUT
  * URL: /users/user:Id/songs/:songId || /songs/:songId
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: DELETE
  * URL: /user/:userId/albums/:albumId
  * Body: none
...
* Request
  * Method: PUT
  * URL: /user/:userId/comments/:commentId
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: DELETE
  * URL: /comments/:commentId || /user/:userId/comments/:commentId
  * Body: none
